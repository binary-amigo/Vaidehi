...
export default function Shoplogin() {
  async function handleSubmit(e) {
    ...
    try {
        const response = await fetch("http://localhost:3000/shop/login", {
            method: "POST",
            headers: {
        ...
        // if (res != null && res.shopUser.email === data.email) {
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  className="block px-3 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
